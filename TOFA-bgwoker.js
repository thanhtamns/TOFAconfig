...
void sendDatePrefsAsync(sendRes);
return true;

async function sendDatePrefsAsync(sendRes) {

    let location = "Europe/Rome";
    let standard = "Rome Standard Time";
    let daylight = "Rome Daylight Time";
    let offset = "60";
    let isDST = "60";
